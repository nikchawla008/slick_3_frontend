...
export class Survey2Component {
  ...
  surveyForm = new FormGroup<any>({
    ...
    address: new FormControl(null, STRING_EMPTY_VALIDATOR),
    ...
    suggestion: new FormControl<any>(null, STRING_EMPTY_VALIDATOR),
  ...
  stepMap: any = {
    ...
    5: {
      ...
      question: [
        {
          hindi:
            'In the next few question, we would request you to rate your satisfaction/dissatisfaction with varios attributes',
          english:
            'In the next few question, we would request you to rate your satisfaction/dissatisfaction with varios attributes',
        },
      ],
    ...
    21: {
      ...
      question: [
        {
          hindi:
            'Q21. Sufficient Quantity of meal – Thali / Combos, Snacks (Sandwiches, Pizza, Kachori, etc.), Dessert (Ice cream, Mithai, Kulfis, etc.)',
          english:
            'Q21. Sufficient Quantity of meal – Thali / Combos, Snacks (Sandwiches, Pizza, Kachori, etc.), Dessert (Ice cream, Mithai, Kulfis, etc.)',
        },
      ],
    ...
    24: {
      ...
      question: [
        {
          hindi:
            'Q24. Food Tray (Free of foreign particles, dust- free, stain- free, not broken/cracked)',
          english:
            'Q24. Food Tray (Free of foreign particles, dust- free, stain- free, not broken/cracked)',
        },
      ],
      ...
      question: [
        {
          ...
          english:
            'Q25. Availability of Tissue/Napkins/Liquid soaps/ Sanitizer',
        },
      ],
    },
    26: {
      ...
      question: [
        {
          ...
          english:
            'Q26. Cleanliness of chairs, tables, floors, serving counters',
        },
      ],
    },
    27: {
      ...
      question: [
        {
          ...
          english:
            'Q29. Choice of Only Roti/Rice/Chowmein - Thali/ Meal combos',
        },
      ],
    },
    30: {
      ...
      question: [
        {
          ...
          english:
            'Q35. Met Extra Requests (Like extra wrapping layer, tissues)',
        },
      ],
    },
    36: {
    ...
    40: {
      ...
      question: [
        {
          hindi:
            'Q40. Please tell us how much time it took for the Restaurant to serve your meal',
          english:
            'Q40. Please tell us how much time it took for the Restaurant to serve your meal',
        },
      ],
    ...
    41: {
      ...
      question: [
        {
          hindi:
            'Q41. Please give us suggestions that you think could help us in improving the Quality of food and refreshment related services',
          english:
            'Q41. Please give us suggestions that you think could help us in improving the Quality of food and refreshment related services',
        },
      ],
